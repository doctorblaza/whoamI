...
const BG = {
  ...
  couple:     'assets/bg-couple.jpg',
  play:       'assets/bg-play.jpg',
  fight:      'assets/bg-fight.jpg',
  roof:       'assets/bg-roof.jpg',
  wallphoto:  'assets/bg-wallphoto.jpg',
  girlrain:   'assets/bg-girlrain.jpg',
